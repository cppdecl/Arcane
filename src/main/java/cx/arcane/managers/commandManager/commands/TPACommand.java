...
public class TPACommand {
    ...
    public void execute(@Sender Player pSender, @Arg OnlinePlayerExceptMeArgument name) {
        ...
        final var gui = Gui.of(3)
                .title(Text.toSmallCapsComponent("Confirm Teleport Request"))
                .statelessComponent(con -> {
                    con.setItem(2, 2, ItemBuilder.from(Material.RED_STAINED_GLASS_PANE)
                            ...
                            .lore(Component.text("Click to cancel the teleport request.", Colors.WHITE).decoration(TextDecoration.ITALIC, false))
                            .asGuiItem((p, ctx) -> {
                    ...
                    con.setItem(2, 8, ItemBuilder.from(Material.LIME_STAINED_GLASS_PANE)
                            ...
                            .lore(Component.text("Click to send " + pTarget.getName() + " a teleport request.",
                            ...
                            .asGuiItem((p, ctx) -> {
                                ...
                                if (TPAManager.hasValidOutgoingRequest(pSender, pTarget)) {
                                    ...
                                    Component resAct = Component.textOfChildren(
                                            Component.text("Please wait a few moments before requesting again!", Colors.DARK_PINK)
                                    );
                                    ...
                                    Component resMsg = Component.textOfChildren(
                                            ...
                                            Component.text(" a teleport request!", Colors.GRAY)
                                    );

                                    Component resAct = Component.textOfChildren(
                                            Component.text("You sent a teleport request!", Colors.HOT_PINK)
                                    );
                                    ...
                                    TPAManager.addRequest(
                                            pSender,
                                            pTarget,
                                            TPAManager.TeleportType.SENDER_TO_TARGET
                                    );

                                    Component tarMsg = Component.textOfChildren(
                                            Component.text(pSender.getName(), Colors.HOT_PINK),
                                            Component.text(" sent you a teleport request ", Colors.GRAY),
